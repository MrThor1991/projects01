...
<?php 
		if (isset($_POST["btn_submit"])) {
			//lấy thông tin từ các form bàng phương thức POST
			...
			if ($username == ""  || $password == "" || $name = "" || $email == "" || $permission == ""){
				echo "bạn pải điền đầy đủ thông tin";
			}
			else{
				...
				//thực thị câu $sql với biến conn lấy từ file connection.php
				$result = mysqli_query($conn, $sql);
				if (!$result){
					echo "người dùng đã tồn tại vui lòng ko trùng username và email !";
				}else{
